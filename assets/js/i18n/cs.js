/* Plik tworzy nastroje/generator.mjs z assets/js/i18n.js.
   ...
   Zawiera tylko język „cs” (oraz polski jako awaryjny). */
const I18N = {
 "pl": {
  "langName": "Polski",
 ...
 "cs": {
  ...
  "meta": {
   ...
   "give": {
    "title": "Podpořte nás | Woda Życia — Koszalin",
   ...
   "privacy": {
    "title": "Ochrana osobních údajů | Woda Życia — Koszalin",
    "desc": "Jak sbor Woda Życia nakládá s osobními údaji a jaká máte podle GDPR práva."
   },
   "notfound": {
    "title": "Stránka nenalezena | Woda Życia — Koszalin",
    "desc": ""
   }
  },
  "ui": {
  ...
  "privacy": {
   ...
   "s4": {
    "h2": "Obsah vložený z jiných služeb",
   ...
   "s6": {
    "h2": "Jak dlouho údaje uchováváme",
