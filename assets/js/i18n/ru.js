/* Plik tworzy nastroje/generator.mjs z assets/js/i18n.js.
   ...
   Zawiera tylko język „ru” (oraz polski jako awaryjny). */
const I18N = {
 "pl": {
  "langName": "Polski",
 ...
 "ru": {
  ...
  "privacy": {
   ...
   "s1": {
    "h2": "Кто является администратором данных",
   ...
   "s4": {
    "h2": "Содержимое, встроенное из других сервисов",
