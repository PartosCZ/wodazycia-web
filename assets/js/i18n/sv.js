/* Plik tworzy nastroje/generator.mjs z assets/js/i18n.js.
   Nie edytuj go ręcznie — przy kolejnym uruchomieniu zmiany przepadną.
   Zawiera tylko język „sv” (oraz polski jako awaryjny). */
const I18N = {
 "pl": {
  "langName": "Polski",
  ...
  "meta": {
   "home": {
    "title": "Kościół Woda Życia — Koszalin",
   ...
   "first": {
    "title": "Jesteś tu pierwszy raz? | Woda Życia — Koszalin",
   ...
   "kids": {
    "title": "Kids | Woda Życia — Koszalin",
  ...
  "privacy": {
   ...
   "s1": {
    "h2": "Kto jest administratorem danych",
   ...
   "s4": {
    "h2": "Treści osadzone z innych serwisów",
   ...
   "s6": {
    "h2": "Jak długo przechowujemy dane",
 ...
 "sv": {
  ...
  "meta": {
   "home": {
    "title": "Församlingen Woda Życia — Koszalin",
   ...
   "first": {
    "title": "Är det första gången här? | Woda Życia — Koszalin",
  ...
  "home": {
   ...
   "hero": {
    ...
    "b": "HALLÅ!",
    "c": "VÄLKOMMEN!",
    "cta": "Låt oss lära känna varandra"
   },
   "visit": {
    "h2": "Kom förbi",
  ...
  "contact": {
   ...
   "map": {
    ...
    "approach": "Infarten från ul. Władysława IV ligger vid byggnaden med företagen Pimax och Marek Mazur. Efter några tiotal meter delar sig vägen — håll till vänster; den högra grenen leder till företaget Chemia."
   }
  },
  "privacy": {
   ...
   "s1": {
    "h2": "Vem är personuppgiftsansvarig",
   ...
   "s4": {
    "h2": "Innehåll inbäddat från andra tjänster",
   ...
   "s6": {
    "h2": "Hur länge vi sparar uppgifter",
