/* Plik tworzy nastroje/generator.mjs z assets/js/i18n.js.
   ...
   Zawiera tylko język „es” (oraz polski jako awaryjny). */
const I18N = {
 "pl": {
  "langName": "Polski",
 ...
 "es": {
  ...
  "meta": {
   "home": {
    "title": "Iglesia Woda Życia — Koszalin",
   ...
   "first": {
    "title": "¿Es tu primera vez aquí? | Woda Życia — Koszalin",
  ...
  "privacy": {
   ...
   "s4": {
    "h2": "Contenido incrustado de otros servicios",
   ...
   "s6": {
    "h2": "Cuánto tiempo conservamos los datos",
