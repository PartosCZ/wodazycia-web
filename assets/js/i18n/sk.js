/* Plik tworzy nastroje/generator.mjs z assets/js/i18n.js.
   ...
   Zawiera tylko język „sk” (oraz polski jako awaryjny). */
const I18N = {
 "pl": {
  "langName": "Polski",
 ...
 "sk": {
  ...
  "meta": {
   ...
   "news": {
    "title": "Aktuality | Woda Życia — Koszalin",
    "desc": "Novinky, akcie a oznamy zo života zboru Woda Życia v Koszaline."
   },
   "give": {
    "title": "Podporte nás | Woda Życia — Koszalin",
   ...
   "privacy": {
    "title": "Ochrana osobných údajov | Woda Życia — Koszalin",
    "desc": "Ako zbor Woda Życia nakladá s osobnými údajmi a aké máte podľa GDPR práva."
   },
   "notfound": {
    "title": "Stránka sa nenašla | Woda Życia — Koszalin",
    "desc": ""
   }
  },
  "ui": {
  ...
  "contact": {
   ...
   "map": {
    "h2": "Ako sa k nám dostanete",
    "directions": "Zobraziť trasu",
    "approach": "Zjazd z ulice Władysława IV je pri budove firiem Pimax a Marek Mazur. Po niekoľkých desiatkach metrov sa cesta rozdvojuje — držte sa vľavo; pravá odbočka vedie k firme Chemia."
   }
  },
  "privacy": {
   ...
   "s1": {
    "h2": "Kto je prevádzkovateľom údajov",
   ...
   "s4": {
    "h2": "Obsah vložený z iných služieb",
