/* Plik tworzy nastroje/generator.mjs z assets/js/i18n.js.
   ...
   Zawiera tylko język „hu” (oraz polski jako awaryjny). */
const I18N = {
 "pl": {
  "langName": "Polski",
 ...
 "hu": {
  ...
  "meta": {
   "home": {
    "title": "Woda Życia Gyülekezet — Koszalin",
  ...
  "contact": {
   ...
   "map": {
    "h2": "Hogyan találsz meg minket",
    "directions": "Útvonal megjelenítése",
    "approach": "A Władysława IV utcáról a behajtó a Pimax és a Marek Mazur cég épületénél van. Néhány tíz méter után az út elágazik — tarts balra; a jobb oldali ág a Chemia céghez vezet."
   }
  },
  "privacy": {
   ...
   "s4": {
    "h2": "Más szolgáltatásokból beágyazott tartalom",
